...
rprof_vs_field(Dblock, "Water", cmap=:Blues, logscale=true, fig=fig, fpos=(1,1), interpolate=true, disp=false, tstart=0.1)
...
rprof_vs_field(Dblock, "Tmean", cmap=:vik100, logscale=true, fig=fig, fpos=(2,1), interpolate=true, disp=false, tstart=0.1)
mantle_water(Dblock, Dblock.timedata[end,2], fig=fig, fpos=(2,3), disp=false)
snapshot(Dblock, 100, "Water", fig=fig, fpos=(1,5), logscale=true)
snapshot(Dblock, 100, "Temperature", fig=fig, fpos=(2,5))
